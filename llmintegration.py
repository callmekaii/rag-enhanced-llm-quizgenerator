...
C. ...
D. ...'''):
        response = model.generate("Make me a 10 questions quiz with 4 multiple choices from A-D according to the order of VARK model with the info provided: "+get_best_chunk(sorted_top_chunks))
